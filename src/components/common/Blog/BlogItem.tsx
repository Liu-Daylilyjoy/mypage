...
const BlogItem: React.FC<{ blog: BlogItemProps, onMouseEnter: () => void, onMouseLeave: () => void }> =
  ({ blog, onMouseEnter, onMouseLeave }) => {
  return (
    <div onMouseEnter={onMouseEnter} onMouseLeave={onMouseLeave} className="cursor-pointer group relative mb-4 w-full bg-secondary/70 p-4 transition-transform duration-300 hover:scale-120 hover:z-11">
